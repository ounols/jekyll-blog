...
[https://copy.sh/v86](https://copy.sh/v86/){: target="_blank"}

[**v86은 브라우저에서 직접 실행할 수 있는 x86 PC 에뮬레이터입니다.**](https://github.com/copy/v86){: target="_blank"} 이 프로젝트는 x86 머신 코드를 런타임에 WebAssembly 모듈로 변환하여 웹 브라우저에서도 합리적인 성능을 달성합니다. 개발자들은 이 에뮬레이터를 통해 Windows 95, Linux, FreeDOS 등 다양한 운영체제를 별도의 설치 없이 웹 페이지에서 바로 실행할 수 있습니다.
